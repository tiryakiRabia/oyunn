...
background = pygame.image.load("image/backgroundd.png")
...
class MovingPointer:
    def __init__(self):
        ...
        self.speed = 2  # Hızı biraz daha yavaşlatıyoruz
        self.running = True
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                pointer.stop()  # Boşluk tuşuyla durdur
            elif event.key == pygame.K_s:
                pointer.stop()  # S tuşuyla da durdur
